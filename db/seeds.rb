...
user5.posts.create(skill_id: 11, description: "Attained my blackbelt at the age of 13, my hands are lethal")
user5.posts.create(skill_id: 16, description: "I spend 3 out of 7 days committing myself to cardio. My go to machine is the stair master. I enjoy climbing the Empire State building. After completing this climb, I then go into a ab circuit, where I do v-ups, crunches, reverse crunches, plank, side to side plank, then hanging leg lifts to the highest elevation I can. I then do goblin swats for 3 sets with a 45 pound weight, 10 resp each set. By this time, my entire shirt is drenched with sweat.")
user5.posts.create(skill_id: 17, description: "I spend 3 out of 7 days lifting. My goal during every session is to push my body to fatigue and end the session by doing dips until failure. During the session, I start with 3 chest exercises, flat bench press, chest fly machine, then machine chest press. Afterwards I move to my back, with machine rows, lat-pull downs, and close grip rows. Then I do tricep pull downs, shoulder raises and a ab circuit. Ending with dips. I have grown from doing no dips to a max of 30 dips.")
user5.posts.create(skill_id: 18, description: "I started my macro journey 10 weeks ago. My intentions with measuring my macro intake was to gauge my metabolic rate. Understanding how my body reacts to certain foods and caloric intake gave me the knowledge to draft an efficient diet that I enjoyed. As time passed and I became accustomed to by daily allowance of calories, I have now pushed myself further and became intermediate fasting. My goal is to reduce my overall body-fat percentage. Join me and become the best version of yourself.")
user5.posts.create(skill_id: 19, description: "The daily nutrition that I find essential is protein with BCAA. BCAA aka Branched-Chain Amino Acid, allows for accelerated muscle recovery. The best part is that it allows for muscle growth while in a caloric deficit. It is perfect for those who want to lose weight without compromising one’s strength. However, the most important thing is still sleep. No matter how many supplements you take, if you don't have healthy sleep regime your body will not be able to react to the supplements to its full potential.")

user4.posts.create(skill_id: 16, description: "I've been running on and off for about 15 years. My longest run has been a little over 8 miles but my usual distance is around 3 miles. My average pace is a 8:30 mile. I practice proper form and would love to teach you in exchange for some sweet skills!")
user4.posts.create(skill_id: 12, description: "I used to compete in High School and College and have one national competitions. I have a fantastic routine and can help you reach your goals!")
user4.posts.create(skill_id: 2, description: "If you're looking to learn how to play the clarinet, I'm your guy! Let me teach you the difference between a C flat and a B sharp so that you can BE SHARP. Ehhhh, haha. Jk, but really. Lemme teach you and offer me something cool to learn in return. Let's hook up!")
...
user2.posts.create(skill_id: 39, description: "I have been working with no SQL base database such as MongoDB")
user2.posts.create(skill_id: 11, description: "Professional pool volleyball player looking to pass on some of my spiking move")
user2.posts.create(skill_id: 12, description: "Muscle up expert willing to train beginner to be able to do muscle up in one month")
user2.posts.create(skill_id: 15, description: "2 times Mt.Vermont skii champion , I can teach you how to perform tricks")
user3.posts.create(skill_id: 27, description: "Originally from Mexico, I have been taught how to cook fantastic South American cusine ranging from Mexico to Argentina")
user3.posts.create(skill_id: 26, description: "Learned how to cook asian dishes during my time spent in Japan")
user3.posts.create(skill_id: 21, description: "Have been tutoring for the past year, extensive knowledge in strategies to succeed in SAT's")
user3.posts.create(skill_id: 23, description: "Graduated fomr DBC, able to teach Ruby/Rails and Javascript")
